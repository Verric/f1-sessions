import { TEAM_COLOURS } from "./constants/teams.js";
import type { CountDownData, F1Session, RaceResults, Schedule, TeamStanding, Weekend } from "./types.js";

/**
 * WARNING
 * Pretty much every function in this file works on the assumption that data is stored chronologically.
 * from race#start time
 */

// CHAMPIONSHIP DATA PROCESSING
